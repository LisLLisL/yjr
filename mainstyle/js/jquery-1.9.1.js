        ...
        function myValidate(rules) {
            ...
            $.each(rules, function () {
                ...
                function sucess() {
                    ...
                    //mod[ru + "_Tips"] = "<span class='right-tips'></span>";
                 ...
                 * checkbox 类型
                 */
                if (ele.attr("type") == "checkbox") {// checkbox 类型
                ...
                ele.watch(function (a) {
                    ...
                    if (isTrue) {
                        if (myRule["equalTo"]) {//判断equals
                            //alert(myRule["equalTo"] +"||"+value);
                            ...
                            return false;
                        }/*else if(myRoule["romote"]){
                         //
                         }*/ else {
                            sucess();
                        }
                    } else {
                        mod[ru + "_Tips"] = "<span>" + mod[ru + "_rules"]["defaultMsg"] + "</span>";
                        tip("hover");
                    }
                });
                ele.data("filter", function () {
                    ...
                    //ajax校验
                    if (isTrue && myRule["romote"] && myRule["requirePath"]) { //校验成功
                        /*
                         if(ele.data("originVal")==value||value==""){//初始值未发生改变不需要ajax提交
                         return false;
                         }*/
                        $.getJSON(myRule["requirePath"], ru + "=" + value, function (data) {
                            //alert(JSON.stringify(data)+"||"+avalon.type(data)+"||" +data.status);
                            if (data.status == 1) {
                                sucess();
                            } else {
                                romoteTo();
                ...
                ss = function () {
                    ...
                    $.each(list, function () {
                        ...
                        if (!self.data("validate")) {
                            var aa = self.data("filter")() || undefined;
                            if (!aa && filter) {
                                filter = false;
                            }
                        }
